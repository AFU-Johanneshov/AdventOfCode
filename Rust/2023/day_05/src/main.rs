...
Wanted to start planning this but no. Just no. I do not have the energy for this.
WHY does day 5 have one of the most annoyingly simple but complex puzzle yet?
*/
mod part_one {
    use crate::reader;
    use std::error::Error;
